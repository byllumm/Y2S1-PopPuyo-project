...
public class ScoreController {
    ...
    // Setters
    public Score getScoreModel() { return scoreModel; }
    public DigitDisplayViewer getScoreViewer() { return scoreViewer; }


    // Getters
    public void setScoreModel(Score scoreModel) { this.scoreModel = scoreModel; }
    public void setScoreViewer(DigitDisplayViewer digitDisplayViewer) { this.scoreViewer = digitDisplayViewer; }


    // Class Methods
    public int computeGroupBonus(int group) { return groupBonusTable[group]; }
